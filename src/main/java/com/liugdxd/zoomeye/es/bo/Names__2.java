...
public class Names__2 {
    ...
    public String toString() {
        ...
        sb.append(Names__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("en");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Names__2) == false) {
            return false;
        }
        Names__2 rhs = ((Names__2) other);
