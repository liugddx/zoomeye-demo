...
public class Names__1 {
    ...
    public String toString() {
        ...
        sb.append(Names__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("en");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Names__1) == false) {
            return false;
        }
        Names__1 rhs = ((Names__1) other);
